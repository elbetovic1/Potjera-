...
__interface INTERFACE_UUID("{58C51A74-C235-408D-824A-768C99EC545B}") IXMLpitanjaType : public Xml::Xmlintf::IXMLNodeCollection
{
public:
public:
  // Property Accessors 
...
__interface INTERFACE_UUID("{098EC817-6227-42D7-B45D-F2DC49C31817}") IXMLpitanjeType : public Xml::Xmlintf::IXMLNode
{
public:
  // Property Accessors 
